...
You research context for a new feature spec on this project, whatever its stack - check `.context/architecture.md`. You will be given a feature description and a set of steps to execute (from `.context/commands/spec.md`).
