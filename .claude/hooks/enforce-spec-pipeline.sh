...
# - No writes to application source code if a spec is in-progress with unchecked criteria.
# Stack-agnostic: instead of matching known frontend/backend folder names, this
# excludes tooling/config/docs paths and enforces on everything else.
