...
Rules:
- Read `.context/coding-conventions/security.md` first - it is authoritative for this project's stack. Read `.claude/skills/security-review-ecc/SKILL.md` only as a supplementary, generic OWASP-style checklist for anything `security.md` doesn't cover; where they disagree, `security.md` wins.
